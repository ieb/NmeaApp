...
class EInkDataStoreFactory {
    constructor (options) {
        this.dataStores = {};
    }

    getStore = function(d, path) {
...
class EInkDrawingContext extends React.Component {
    constructor(options) {
    ...
    */
    ...
    setOrientation(portrait, width, height) {
...
class EInkCircularStats extends EInkStats {
    constructor(options) {
        super(options);
        this.sinvalues = [];
        this.cosvalues = [];
...
class EInkTextBox {
    ...
    static number(path, name, units, precision, scale, offset) {
    ...
    static text(path, name, units, displayFn) {
        return  new EInkTextBox({
            path: path,
            labels: {
                bl: name,
    ...
    toDispay(v, precision, displayUnits, neg, pos) {
    ...
    formatOutput(data, scale, precision, offset) {
    ...
    setSize(cols, rows, screenWidth, screenHeight) {
    ...
    render(ctx, theme, dataStoreFactory) {
...
class EInkEngineStatus extends EInkTextBox {
    constructor(path) {
        super({
            path: path,
            withStats: false
...
class EInkPilot extends EInkTextBox {
    constructor(x, y) {
        super({
            path: "none",
            x: x,
    ...
    render(ctx, state, theme, dataStoreFactory) {
...
class EInkLog extends EInkTextBox {
    constructor(x,y) {
        super({
            path: "none",
            x: x,
...
class EInkFix extends EInkTextBox {
    constructor(x,y) {
        super({
            path: "none",
            x: x,
...
class EInkPossition extends EInkTextBox {
    constructor(x,y) {
        super({
            path: "none",
            x: x,
...
class EInkCurrent extends EInkTextBox {
    constructor(x,y) {
        super({
            path: "none",
            x: x,
...
class EInkAttitude extends EInkTextBox {
    constructor(x,y) {
        super({
            path: "none",
            x: x,
...
class EInkRelativeAngle extends EInkTextBox {
    constructor(path, label, x, y, precision ) {
        super({
            path: path,
            labels: {
                bl: label,
    ...
    formatOutput(data, scale, precision) {
        scale = scale || this.scale;
...
class EInkSpeed extends EInkTextBox {
    constructor(path, label, x, y, precision) {
        super({
            path: path,
            labels: {
...
class EInkDistance extends EInkTextBox {
    constructor(path, label, x, y, precision) {
        super({
            path: path,
            labels: {
...
class EInkBearing  extends EInkTextBox {
    constructor(path, label, x, y, precision) {
        super({
            path: path,
            labels: {
...
// todo
class EInkTemperature extends EInkTextBox {
    constructor(path, label, x, y, precision) {
        super({
            path: path,
            labels: {
...
// todo
class EInkSys extends EInkTextBox {
    constructor(x, y) {
        super({
            path: "none",
            labels: {
...
class EInkRatio extends EInkTextBox {
    constructor(path, label, x, y, precision ) {
        super({
            path: path,
            labels: {
