...
class NMEA0183Handler {
    ...
    parseSentence(line) {
        const sentenceIdent = this.getSentenceId(line);
        if ( sentenceIdent !== undefined) {
            this.mergeSentence(sentenceIdent.key, sentenceIdent);
        }
    }
...
//$IIVHW,356.9,T,356.8,M,5.1,N,9.4,K*5D
    getSentenceId(line) {
        const parts = this.getParts(line);
        if ( parts !== undefined) {
            return {
    ...
    exports.NMEA0183Handler = NMEA0183Handler;
